...
public class Commande {
    ...
    private boolean isSpecialMenu = false; //can be true if the commande is a special menu or false if it's a normal commande
    ...
    */
    ...
    /**
    * This function sets the value of the isSpecialMenu variable to the value of the isSpecialMenu
    * parameter
    * 
    * @param isSpecialMenu boolean
    */
    public void setIsSpecialMenu(boolean isSpecialMenu) {
        this.isSpecialMenu = isSpecialMenu;
    }
    
    /**
    * This function returns the value of the variable isSpecialMenu
    * 
    * @return The value of the isSpecialMenu variable.
    */
    public boolean getIsSpecialMenu() {
        return this.isSpecialMenu;
    }
    ...
    */
    ...
    /**
    * If the map is empty, return 0. Otherwise, if the menu is special, the 7 firsts food and drink cost 100,
    *  otherwise add the price of all items to the total price.
    * 
    ...
    */
    ...
    public double getTotalPrice(){
        ...
        /* if is a special menu the first 7 foods and 7 drinks prices are = to 0*/
        int index = 0;
        for (Map.Entry<Drink, Integer> entry : boissonMap.entrySet()) {
            
            for(int i = 0; i < entry.getValue(); i++){
                if(index < 7 && isSpecialMenu){
                    totalPrice += 0;
                }else{
    ...
    */
    ...
    /**
    * It returns the total number of food in the map
    * 
    * @return The total number of food in the map.
    */
    public int getNbFood() {
        /*function that add every food in the map and return the total number of food*/
        int nbFood = 0;
        for (Map.Entry<Food, Integer> entry : platMap.entrySet()) {
            nbFood += entry.getValue();
        }
        return nbFood;
    }
    
    /**
    * This function returns the total number of drinks in the map
    * 
    * @return The total number of drinks
    */
    public int getNbDrink() {
        /*function that add every drink in the map and return the total number of drink*/
        int nbDrink = 0;
        for (Map.Entry<Drink, Integer> entry : boissonMap.entrySet()) {
            nbDrink += entry.getValue();
        }
        return nbDrink;
    }
    ...
    */
    public void printCommande(){
        ...
        printDrinkList();
        if(isSpecialMenu){
            System.out.println("1 menu special (7 premiers plats et 7 premières boissons à 100€)");
        }
